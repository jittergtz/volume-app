...
const ArtistHeader: React.FC<HeaderProps> = ({ children, className }) => {
  ...
  return (
    ...
    >
      <div className=" hidden sm:flex   items-center justify-between absolute top-0 z-50 px-2 h-16 w-full bg-black/50">
        ...
        <div className="flex justify-between items-center gap-x-4">
          {user ? (
            ...
            <>
              <div>
                <ButtonLogin onClick={authModal.onOpen}>Anmelden</ButtonLogin>
              </div>
            </>
          )}
        </div>
