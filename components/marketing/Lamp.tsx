...
export const LampContainer = ({
  ...
  return (
    <div
      className={cn(
        "relative flex min-h-screen  flex-col items-center justify-center overflow-hidden bg-slate- w-full rounded-md z-0",
        className
      )}
    >
      ...
      <div className="relative z-50 flex sm:-translate-y-80 -translate-y-[23rem]  flex-col items-center px-5">
        {children}
      </div>
    </div>
  )
