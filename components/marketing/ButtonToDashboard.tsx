...
function ButtonToDashboard() {
  ...
  return (
    <Link href={"/dashboard"}>
<button className="relative z-50 inline-flex h-12 overflow-hidden rounded-full p-[1px] focus:outline-none focus:ring-2 focus:ring-slate-400 focus:ring-offset-2 focus:ring-offset-slate-50">
